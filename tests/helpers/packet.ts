 ...
 */
export function calculateChecksum(c3: number, data: Uint8Array): number {
 ...
 */
export function floatToLittleEndian(value: number): Uint8Array {
 ...
 * @param {number|number[]|Uint8Array} data - データ
 * @returns {Uint8Array} 完全なコマンドパケット
 */
export function createCommandPacket(header: number, command: number, type: number, data: number | number[] | Uint8Array): Uint8Array {
 ...
 * @returns {Uint8Array} 完全なコマンドパケット
 */
export function createFloatCommandPacket(header: number, command: number, type: number, value: number): Uint8Array {
 ...
 */
export function createResponsePacket(type: number, data: number | number[] | Uint8Array): Uint8Array {
 ...
 * @returns {Uint8Array} 完全なレスポンスパケット
 */
export function createFloatResponsePacket(type: number, value: number): Uint8Array {
  const dataBytes = floatToLittleEndian(value);
 ...
 * @returns {Uint8Array} 完全なレスポンスパケット
 */
export function createMultiFloatResponsePacket(type: number, values: number[]): Uint8Array {
 ...
 * @returns {Uint8Array} 完全なレスポンスパケット
 */
export function createStringResponsePacket(type: number, text: string): Uint8Array {
 ...
 * @param {AllResponseData} data - 全データのオブジェクト
 * @returns {Uint8Array} 完全なレスポンスパケット
 */
export function createAllResponsePacket(data: AllResponseData): Uint8Array {
  // 139バイトの固定サイズ（実装を参照）
